...
import net.dkr.freelancing.fragments.seller_home_Fragment;
...
public class SellerMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().add(new seller_Profile_Fragment(),"seller_Profile_Fragment").replace(R.id.frameLayout_seller,new seller_Profile_Fragment()).commit();
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                if (menuItem.getItemId() ==  R.id.seller_profile) {
                    ...
                    fragment = new seller_home_Fragment();
                }
                else
                {
                    fragment = new seller_Profile_Fragment();
